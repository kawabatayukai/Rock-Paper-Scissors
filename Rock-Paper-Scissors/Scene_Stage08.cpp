...
Scene_Stage08::Scene_Stage08(const Player* player)
{
	...
	obj_floor[3] = new Floor(211, 590, 100, 5);      //足場　下1
	obj_floor[4] = new Floor(465, 590, 105, 5);      //足場　下2
	obj_floor[5] = new Floor(717, 590, 107, 5);      //足場　下3
	obj_floor[6] = new Floor(973, 590, 110, 5);      //足場　下4
	obj_floor[7] = new Floor(307, 470, 160, 5);      //足場　右下
	obj_floor[8] = new Floor(565, 470, 153, 5);      //足場　右下
	obj_floor[9] = new Floor(820, 470, 153, 5);      //足場　右下
	obj_floor[10] = new Floor(465, 470, 5, 120);      //足場　右下
	obj_floor[11] = new Floor(306, 470, 5, 120);      //足場　右下
	obj_floor[12] = new Floor(717, 470,  5,120);      //足場　右下
	obj_floor[13] = new Floor(973, 470,  5,120);      //足場　右下
	obj_floor[14] = new Floor(565, 475, 5, 120);      //足場　右下
	obj_floor[15] = new Floor(820, 475, 5, 120);      //足場　右下

	obj_floor[16] = new Floor(311, 290, 100, 5);      //足場　右下
	obj_floor[17] = new Floor(565, 290, 105, 5);      //足場　右下
	obj_floor[18] = new Floor(817, 290, 108, 5);      //足場　右下
	obj_floor[19] = new Floor(1073, 290, 445, 5);      //足場　右下
	obj_floor[20] = new Floor(407, 170, 160, 5);      //足場　右下
	obj_floor[21] = new Floor(665, 170, 153, 5);      //足場　右下
	obj_floor[22] = new Floor(920, 170, 153, 5);      //足場　右下
	obj_floor[23] = new Floor(565, 170, 5, 120);      //足場　右下
	obj_floor[24] = new Floor(406, 170, 5, 120);      //足場　右下
