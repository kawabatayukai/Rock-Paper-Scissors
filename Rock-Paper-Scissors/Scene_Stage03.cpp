...
Scene_Stage03::Scene_Stage03(const Player* player)
{
	...
	obj_floor[4] = new Floor(800, 130, 120, 50);      //足場2//130
	obj_floor[5] = new Floor(600, 160, 120, 50);      //足場3//100
	obj_floor[6] = new Floor(400, 190, 120, 50);      //足場4//130
	obj_floor[7] = new Floor(220, 210, 120, 50);      //足場5//130
	obj_floor[8] = new Floor(120, 550, 120, 50);      //足場6//100
	obj_floor[9] = new Floor(15, 450, 120, 50);      //足場7//130
	obj_floor[10] = new Floor(15, 250, 120, 50);      //足場8//130
