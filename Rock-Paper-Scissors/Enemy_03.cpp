...
Enemy_03::Enemy_03(float x, float y, Jan_Type type) : EnemyBase(x, y, 100.0f, 100.0f, type)
{
	...
	moveinfo[5] = { 1,  0 ,   0.f , 6, 125 ,1 };//Xが350で停止
	...
	//前回の逆パターンへ
	moveinfo[21] = { 0, 1050.f , 0.f , 22, 0, 0 };//Xが1050の足場に飛ぶ
	...
	moveinfo[29] = { 1,  0 ,   0.f , 30, 125,1 };//Xが465で停止
	...
	moveinfo[31] = { 0, 70.f,  0.f , 32,  0 ,0 };//Xが70まで動く

	moveinfo[32] = { 1,  0 ,   0.f , 33, 125,1 };//Xが70で停止
	//ここから動く2
	moveinfo[33] = { 0, 350.f, 0.f , 34,  0 ,1 };//初期位置のXが350で停止

	moveinfo[34] = { 1,  0 ,   0.f , 35, 125 ,1 };//初期位置のXが350で停止

	moveinfo[35] = { 0, 650.f, 0.f , 36,  0 ,1 };//Xが650まで動く

	moveinfo[36] = { 1,  0 ,   0.f , 37, 125 ,1 };//Xが650で停止

	moveinfo[37] = { 0,	900.f, 0.f , 38, 0 ,1 };//Xが900まで動く

	//moveinfo[47] = { 1,	 0,  0.f , 48, 62 ,1 };//Xが900で少しの時間停止

	moveinfo[38] = { 1,  0 ,   0.f , 0, 125 ,1 };//Xが900で停止し配列[0]に戻る
