...
//初期処理
void Scene_Result::KeyBoardInit()
{
	//カーソルの初期位置は"A"
	movekeyX = 0;             //ｘ方向0番目
	movekeyY = 0;             //ｙ方向1番目
...
//}
////描画
//void Scene_Result::DrawKeyBoard()
//{
//	//背景
...
//}
////移動
//void Scene_Result::KeyBoardControl(int NowKey)
//{
//	//フレーム数カウント
//	frame++;
//	//→ 右
...
//void Scene_Result::Push_A_Key(int NowKey, int* GameState, int Score)
//{
//	//"押した瞬間"を判定
//	static int push_B;
...
//}
////入力情報表示
//void Scene_Result::DrawInputInfo()
//{
//	if (InputName[0] == 0)
//	{
//		//SetDrawBlendMode
...
//}
////コントローラー調整
//int Scene_Result::InputControl()
//{
//	int timing = 8;
//	return frame % timing;
//}
////＊test用＊　各種情報表示
//void Scene_Result::DrawTestInfo()
//{
//	//InputNameチェック
