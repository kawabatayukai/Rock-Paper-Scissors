...
Scene_Stage05::Scene_Stage05(const Player* player)
{
	...
	obj_floor[3] = new Floor(220, 355, 120, 5);      //足場　(左上)
	obj_floor[4] = new Floor(220, 535, 120, 5);      //足場　(左下)
	obj_floor[5] = new Floor(220, 535, 120, 5);      //足場　(真ん中)
	obj_floor[6] = new Floor(220, 535, 120, 5);      //足場　(右上)
	obj_floor[7] = new Floor(220, 535, 120, 5);      //足場　(右下)
}
