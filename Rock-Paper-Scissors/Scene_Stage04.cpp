...
Scene_Stage04::Scene_Stage04(const Player* player)
{
	...
	obj_floor[1] = new Floor(0, 0, 1280, 1);			//天井
	obj_floor[2] = new Floor(0, 0, 20, 1720);			//壁（左）
	obj_floor[3] = new Floor(1260, 0, 20, 1720);		//壁（右）
	obj_floor[4] = new Floor(300, 500, 200, 15);		//足場(下横)
	obj_floor[5] = new Floor(600, 350, 150, 15);		//足場(真ん中横)
	obj_floor[6] = new Floor(400, 180, 150, 15);		//足場(上横)
	obj_floor[7] = new Floor(390, 425, 15, 170);		//足場(下縦)
	obj_floor[8] = new Floor(667, 295, 15, 130);		//足場(真ん中縦)
	obj_floor[9] = new Floor(467, 125, 15, 130);		//足場(上縦)
	obj_floor[10] = new Floor(0, 320, 100, 10);			//棘①
	obj_floor[11] = new Floor(0, 540, 70, 10);			//棘②
	obj_floor[12] = new Floor(300, 0, 10, 80);			//棘③
	obj_floor[13] = new Floor(900, 0, 10, 130);			//棘④
	obj_floor[14] = new Floor(1100, 0, 10, 40);			//棘⑤
	obj_floor[15] = new Floor(1180, 150, 100, 10);		//棘⑥
	obj_floor[16] = new Floor(1230, 400, 30, 10);		//棘⑦
	obj_floor[17] = new Floor(1000, 650, 10, 70);		//棘⑧
	obj_floor[18] = new Floor(700, 680, 10, 40);		//棘⑨
}
