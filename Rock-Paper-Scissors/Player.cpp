...
, player_Image(0), playerGetMove(0), playerCount(0), playerChange_Image(0), pCount(0), player_state(PLAYER_STATE::ALIVE)
{
	...
	LoadDivGraph("images/ワンパンマン画像顔無し.png", 10, 5, 2, 100, 100, image[0]);

	image[0][4] = LoadGraph("images/ワンパンマンジャンプ画像腕無し右.png");
	image[0][9] = LoadGraph("images/ワンパンマンジャンプ画像腕無し左.png");

	//死亡時
	image_death = LoadGraph("images/ワンパンマン顔のみ.png");
